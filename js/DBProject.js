class ProjectInfoPage extends TeacherInfoPage {
    static TblName = 'project';
    constructor(tblname) {
        super(tblname);
    }
    display() {
        ProjectInfoPage.clean();
        ProjectInfoPage.DisplayData();
        this.buildInsertDiv();
        this.buildQueryDiv();
        this.buildDeleteDiv();
    }
    ...
    static DisplayData() {
        getTableData(ProjectInfoPage.TblName);
        var tabledata = TableData.get(ProjectInfoPage.TblName);
        ...
        this.InfoTable = generateTable2D(tabledata.length, tabledata[0].length, tabledata, ProjectInfoPage.TblName);
    ...
    static DisplayQueryResult() {
        ...
        var tabledata = QueryResult.get(ProjectInfoPage.TblName);
        if (tabledata == null || tabledata.length == 0) return;
        this.QueryTable = generateTable2D(tabledata.length, tabledata[0].length, tabledata, ProjectInfoPage.TblName);
    ...
    buildInsertDiv() {
        ...
        button.onclick = function () {
            ...
            var colnames = ColumnInfo.get(ProjectInfoPage.TblName);
            ...
            insertIntoTable(ProjectInfoPage.TblName, data_map);
            ProjectInfoPage.DisplayData();
        }//function
        button.width = "30px";
        button.innerHTML = "提交";
    ...
    buildQueryDiv() {
        ...
        button.onclick = function () {
            ...
            //alert(whereClause);
            queryTableData(ProjectInfoPage.TblName, whereClause);
            ProjectInfoPage.DisplayQueryResult();
        }//function
        button.width = "30px";
        button.innerHTML = "提交";
    ...
    buildDeleteDiv() {
        ...
        button.onclick = function () {
            ...
            deleteFromTable(ProjectInfoPage.TblName, data_map);
            ProjectInfoPage.DisplayData();
        }//function
        button.width = "30px";
        button.innerHTML = "提交";

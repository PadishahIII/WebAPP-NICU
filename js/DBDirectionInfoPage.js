class DirectionInfoPage extends TeacherInfoPage {
    static TblName = 'direction';
    constructor(tblname) {
        super(tblname);
    }
    display() {
        DirectionInfoPage.clean();
        DirectionInfoPage.DisplayData();
        this.buildInsertDiv();
        this.buildQueryDiv();
        this.buildDeleteDiv();
    }
    ...
    static DisplayData() {
        getTableData(DirectionInfoPage.TblName);
        var tabledata = TableData.get(DirectionInfoPage.TblName);
        ...
        this.InfoTable = generateTable2D(tabledata.length, tabledata[0].length, tabledata, DirectionInfoPage.TblName);
    ...
    static DisplayQueryResult() {
        ...
        var tabledata = QueryResult.get(DirectionInfoPage.TblName);
        if (tabledata == null || tabledata.length == 0) return;
        this.QueryTable = generateTable2D(tabledata.length, tabledata[0].length, tabledata, DirectionInfoPage.TblName);
    ...
    buildInsertDiv() {
        ...
        button.onclick = function () {
            ...
            var colnames = ColumnInfo.get(DirectionInfoPage.TblName);
            ...
            insertIntoTable(DirectionInfoPage.TblName, data_map);
            DirectionInfoPage.DisplayData();
        }//function
        button.width = "30px";
        button.innerHTML = "提交";
    ...
    buildQueryDiv() {
        ...
        button.onclick = function () {
            ...
            //alert(whereClause);
            queryTableData(DirectionInfoPage.TblName, whereClause);
            DirectionInfoPage.DisplayQueryResult();
        }//function
        button.width = "30px";
        button.innerHTML = "提交";
    ...
    buildDeleteDiv() {
        ...
        button.onclick = function () {
            ...
            deleteFromTable(DirectionInfoPage.TblName, data_map);
            DirectionInfoPage.DisplayData();
        }//function
        button.width = "30px";
        button.innerHTML = "提交";
